...
class TestExceptions(TestCase):
    def testApiException(self):
        ...
        self.assertEquals("Generic Api Error", e.get_description())
    ...
    def testInvalidEnvelopeException(self):
        ...
        self.assertEquals("Invalid Envelope: General Error", e.get_description())
        self.assertEquals(1100, e.get_code())
